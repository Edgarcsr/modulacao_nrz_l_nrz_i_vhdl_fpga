...
entity nrz_i_top is
    ...
    Port (
        ...
        tx_pmod  : out STD_LOGIC; -- Saída para o osciloscópio (Pmod JA1)
...
architecture Behavioral of nrz_i_top is
...
begin
    ...
    -- Expõe os sinais internos para os LEDs e para o PMOD simultaneamente
    nrz_out <= nrz_signal;
    tx_pmod <= nrz_signal;
    bit_idx <= bit_ptr;

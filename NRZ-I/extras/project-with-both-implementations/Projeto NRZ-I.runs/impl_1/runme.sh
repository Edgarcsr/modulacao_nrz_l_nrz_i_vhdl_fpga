...
HD_PWD='C:/Users/081230039/Desktop/modulacao_nrz_l_nrz_i_vhdl_fpga/NRZ-I/extras/project-with-both-implementations/Projeto NRZ-I.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nrz_i_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nrz_i_top.tcl -notrace

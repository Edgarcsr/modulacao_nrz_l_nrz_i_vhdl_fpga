...
HD_PWD='C:/Users/081230039/Desktop/modulacao_nrz_l_nrz_i_vhdl_fpga/NRZ-L/extras/project-with-both-implementations/Projeto NRZ-L.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nrz_l.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nrz_l.tcl

...
HD_PWD='C:/Users/081230039/Desktop/modulacao_nrz_l_nrz_i_vhdl_fpga/NRZ-L/extras/project-with-both-implementations/Projeto NRZ-L.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nrz_l.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nrz_l.tcl -notrace
